...
class SuperResolution(object):
    ...
    def train(self, epoches=100, batch_size=8, weights_save_path=None):
    ...
    def sample(self, setpath='datasets/train/HR', save_folder='samples', epoch=1, batch=1):
        ...
        lr = self.data_loader.imread(os.path.join('datasets/train/LR', imgname + 'x4' + extension))
